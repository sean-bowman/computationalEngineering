...
from WaterSim.sph.wcsphSolver import WcsphSolver
...
from WaterSim.scenarios.numericalWaveTank import WaveTankConfig, createNumericalWaveTank
...
def buildParser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        '--output-dir', type=str, default='WaterSim/output',
...
class WaterSimRunner:
    ...
    def runFromConfig(self, configPath: str, exportDir: str = 'WaterSim/output') -> dict:
        '''
