...
SCENES = {
    'wave_intro': {
        'file': 'SurfAnimations/scenes/waveIntro.py',
        'class': 'WavePhysicsIntro',
        'description': 'Linear wave theory introduction',
    },
    'board_side': {
        'file': 'SurfAnimations/scenes/boardOnWave.py',
    ...
    'performance': {
        'file': 'SurfAnimations/scenes/performanceComparison.py',
        'class': 'PerformanceComparison',
        'description': 'Multi-board performance comparison',
    },
    'sloshing_tank': {
        'file': 'SurfAnimations/scenes/sloshingTank.py',
...
def renderScene(sceneName, quality='high'):
    ...
    cmd = [
        ...
        qualityFlag,
        '--media_dir', os.path.join(projectRoot, 'SurfAnimations', 'media'),
