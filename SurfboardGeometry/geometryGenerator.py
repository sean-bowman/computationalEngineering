...
class GeometryGenerator:
    ...
    def generateFromConfig(self, configPath: str) -> str:
        ...
        outputDir = config.get('outputDir', 'SurfboardGeometry/Output')
        ...
        # Locate the output STL
        rootDir = os.path.dirname(self._projectDir)
    ...
    def _loadConfig(self, configPath: str) -> dict:
        ...
        return {
            ...
            'outputDir': geometry.get('outputDir', 'SurfboardGeometry/Output'),
        }
